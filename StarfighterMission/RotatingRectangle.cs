...
//rozwi¹zanie problemu z obracanymi prostok¹tami: http://www.xnadevelopment.com/tutorials/rotatedrectanglecollisions/rotatedrectanglecollisions.shtml
//objaœnienie algorytmu SAT: http://zajacmarek.com/wp-content/uploads/2012/12/Algorytm-SAT.pdf
...
namespace StarfighterMission
{
    class RotatingRectangle
    {
        ...
        public RotatingRectangle(Rectangle theRectangle, float theInitialRotation)
        {
        ...
        {
            return Intersects(new RotatingRectangle(theRectangle, 0.0f));
        }
        ...
        /// <param name="theRectangle"></param>
        /// <returns></returns>
        public bool Intersects(RotatingRectangle theRectangle)
        {
        ...
        /// <returns></returns>
        private bool IsAxisCollision(RotatingRectangle theRectangle, Vector2 aAxis)
        {
